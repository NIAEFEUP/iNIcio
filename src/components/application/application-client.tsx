    ...
    <div className="container mx-auto px-4 py-8 md:py-12 max-w-3xl">
          ...
          <CardContent className="p-4">
            <Accordion>
              <AccordionItem value="tips" className="border-b-0">
                ...
                <AccordionContent className="pt-3 pb-1 text-xs md:text-sm text-muted-foreground space-y-3">
                  <div className="space-y-1">
                    ...
                    <p>
                      • A submissão de CV e links (GitHub, LinkedIn, portfólio)
                      é opcional, mas valorizada!
                    </p>
                  </div>
                  <div className="grid sm:grid-cols-3 gap-3 pt-2">
                    <div className="rounded-lg border border-border p-2.5 bg-background">
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">
                        Desenvolvimento de software real para a comunidade
                        académica (UNI, TTS, NitSig).
                      </p>
                    </div>
                    <div className="rounded-lg border border-border p-2.5 bg-background">
                      <p className="font-medium text-foreground text-xs">
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">
                        Organização da Semana de Informática (Sinf), workshops e
                        convívios académicos.
                      </p>
                    </div>
                    <div className="rounded-lg border border-border p-2.5 bg-background">
                      <p className="font-medium text-foreground text-xs">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <CVUpload onSuccess={handleCVSuccess} onError={handleUploadError} />
          </CardContent>
        </Card>

        {/* Section 3: Links Sociais */}
        <Card>
          <CardHeader>
            <div className="flex items-center gap-2.5">
              <div className="size-8 rounded-md bg-primary/10 flex items-center justify-center">
        ...
        {/* Section 5: Experiência & Motivação */}
        <Card>
          <CardHeader>
            <div className="flex items-center gap-2.5">
              <div className="size-8 rounded-md bg-primary/10 flex items-center justify-center">
              ...
              <div>
                <CardTitle className="text-lg">Percurso & Motivação</CardTitle>
                <CardDescription>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="motivation">Porquê o NIAEFEUP? *</Label>
              <Textarea
                id="motivation"
                name="motivation"
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <CardTitle className="text-lg">Como nos descobriste?</CardTitle>
                <CardDescription>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                {DISCOVERY_OPTIONS.map((item) => {
                  const checked =
                    formData.recruitment_first_interaction.includes(item.value);
                  return (
                    <label
                      key={item.value}
            ...
            <div className="space-y-2 pt-2">
              ...
              <Textarea
                id="suggestions"
                name="suggestions"
                placeholder="Alguma ideia de projeto, evento ou melhoria que gostarias de ver no NIAEFEUP?"
