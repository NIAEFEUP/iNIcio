    ...
    <div className="max-w-7xl mx-auto p-8 my-16 flex flex-col gap-y-4">
      <header className="mb-8">
        ...
        <p className="text-md mt-4">
          By using this service you agree to the privacy policy described below.
        </p>
      </header>
        ...
        <ul className="list-disc ml-8 flex flex-col gap-y-2">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to NIAEFEUP.
            </p>
          </li>
          <li>
            <p>
      ...
      <article className="flex flex-col gap-y-1">
        ...
        <ul className="list-disc ml-8 flex flex-col gap-y-2">
          ...
          <li>
            <p>
              Experience, motivation and reasons for wanting to join NIAEFEUP
            </p>
          </li>
        </ul>
        ...
        <p>
          The Company will not retain Usage Data for internal analysis purposes.
        </p>
      </article>
